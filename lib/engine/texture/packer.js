export class AtlasPacker {
    ...
    async generateAtlas(imageElements) {
        ...
        // 2. Inicializar el nodo raíz (todo el espacio del canvas está libre)
        // Empezamos con un tamaño estimado y aumentará si es necesario
        let atlasWidth = 128;
        let atlasHeight = 128;
